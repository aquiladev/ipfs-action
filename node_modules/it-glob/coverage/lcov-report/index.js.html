...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (minimatch(relativeDir, pattern)) {
    yield options.absolute ? <span class="branch-0 cbranch-no" title="branch not covered" >absoluteDir </span>: relativeDir
  }
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Nov 26 2019 17:42:14 GMT+0000 (Greenwich Mean Time)
</div>
</div>
