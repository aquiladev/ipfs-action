declare function _exports(clientOptions: import("../types").Options): import("ipfs-core-types/src/refs").Refs<import("../types").HTTPClientExtraOptions> & {
    local: (options?: (import("ipfs-core-types").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => AsyncIterable<import("ipfs-core-types/src/refs").RefsResult>;
};
export = _exports;
