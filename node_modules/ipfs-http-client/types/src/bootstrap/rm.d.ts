 ...
 */
export const createRm: import("../lib/configure.js").Factory<(addr: Multiaddr, options?: (import("ipfs-core-types/src/utils").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<{
    Peers: Multiaddr[];
}>>;
